...
from model import G_NET_64, G_NET_128, G_NET_256, D_NET64, D_NET128, D_NET256, INCEPTION_V3, VGG19
...
def define_optimizers(netG_64,netG_128,netsD):
    optimizersD = []
    num_Ds = len(netsD)
    ...
    #                         lr=cfg.TRAIN.GENERATOR_LR, #learning rate=0.0002
    #                         betas=(0.5, 0.999))
    return optimizerG_64, optimizerG_128, optimizersD

def save_model(netG_64, avg_param_G_64,netG_128, avg_param_G_128,netsD,epoch, model_dir):
...
def save_img_results(imgs_tcpu, fake_imgs_64,fake_imgs_128,num_imgs,
                     count, image_dir):
...
class condGANTrainer(object):
    ...
    def train_Dnet(self, idx, count):
        ...
        #lsgan_loss = 0.5 * (l2_distance(real_logits[0], real_labels) + l2_distance(fake_logits[0], fake_labels))
        ...
        if len(real_logits) > 1 and cfg.TRAIN.COEFF.UNCOND_LOSS > 0:
            ...
            errD = errD_real + 0.5 * (errD_wrong + errD_fake) + loss_tac   #tac+wgan_gp
        else:
    ...
    def train_Gnet(self, count):
        ...
        for i in range(self.num_Ds):
            ...
            errG_total = errG_total + errG + second_part
    ...
    def train(self):
        self.netG_64, self.netsD, self.num_Ds, \
            self.inception_model, start_count,self.netG_128 = load_network(self.gpus)
        ...
        self.optimizerG_64,self.optimizerG_128,self.optimizersD = \
            define_optimizers(self.netG_64,self.netG_128,self.netsD)
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            for step, data in enumerate(self.data_loader, 0):
                ...
                self.fake_imgs_64, self.mu, self.logvar, h_code_64 = \
                ...
                if count % cfg.TRAIN.SNAPSHOT_INTERVAL == 0:
                    save_model(self.netG_64, avg_param_G_64,self.netG_128, avg_param_G_128,self.netsD, count, self.model_dir)
                    ...
                    save_img_results(self.imgs_tcpu, self.fake_imgs_64,self.fake_imgs_128,self.num_Ds,
                    ...
                    with open('loss_128_flowers_tac+h.pkl', 'wb') as f:
                        pkl.dump(loss, f)
                    with open('inception_128_flowers_tac+h.pkl', 'wb') as f:
            ...
            G_loss = []
            KL_loss = []
            D_loss.append(errD_total.data[0])
            G_loss.append(errG_total.data[0])
            KL_loss.append(kl_loss.data[0])
            loss[epoch] = {}
    ...
    def evaluate(self, split_dir):
        if cfg.TRAIN.NET_G_64 == '':
            ...
            s_tmp = cfg.TRAIN.NET_G_128    # the path to save generated images
            ...
            for step, data in enumerate(self.data_loader, 0):
                ...
                for i in range(embedding_dim):
                    ...
                    if cfg.TEST.B_EXAMPLE:
                        ...
                        fake_img_list.append(fake_imgs_128[0].data.cpu())
                    else:
                        self.save_singleimages(fake_imgs_128[0], filenames,
